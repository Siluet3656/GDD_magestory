...
Развитие в забеге: эссенции (предметы аля ROR)

Core Loop (30–60 сек):

* Выбор позиции
* Выбор цели
* Комбинация эффектов (стихия → эффект → взрыв)
* Реакция на угрозу (дэш / контроль / заморозка)
...
- Вариативность прохождения. 3 локи. Каждая даст бафф к чему-то + способности. У каждой локи свой стиль, соответствующий своей стихии. После прохождения локи меняется мейн лока.
- Рогаликовая часть: стихийные локи проходятся "рогаликово". Амулеты получаются во время прохождения такой локи (пропадают после смерти/прохождения).
