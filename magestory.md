...
11. Отмена каста - <kbd>Num 1</kbd>
12. Выбрать цель - <kbd>Mouse0</kbd>
13. Отменить выбор цели - <kbd>Mouse1</kbd>
14. Быстрая смена цели - <kbd>Num 2</kbd>
15. Меню - <kbd>Esc</kbd>
16. Действие - <kbd>'</kbd>
17. Книга заклинаний - <kbd>Num 9</kbd>
### Геймпад икскоробка
### Геймпад сосони
---
## <a id="title4">Стиль</a>
...
2. Система передвижения
  - базовое движение
  - скорости: нет, медленно, обычно, быстро
  - дэш (блинк)
...
### Система заклинаний
Для каста необходимо вынести скилл из книги на панель. После нажать соответствующий кейбинд на панели. При касте скорость движения меньше. Отмена каста по кнопке.
#### Заклинания
...
5. Параметры шардов
  - о.ш: даёт 20 ост. рефреш: 3 сек.
  - м.ш: даёт 20 ост. рефреш: 3 сек.
  - з.ш: даёт 20 ост. рефреш: 3 сек.
6. Параметры босса
  - ХП: 20000
  - атака1
7. Фазы босса
