...
- огненная метка: увеличивает вероятность получить критический урон.
...
#### Заклинания
- Огонь:
  1. фаерболл: наносит урон выбранной цели и в умеренном радиусе вокруг неё.
  2. взрыв: наносит урон в умеренном радиусе вокруг заклинателя. Стихия: огонь.  Мгновенное.
  3. огненная стена: создаёт стену огня в выбранной области. При касании стена наносит урон.
  4. огненный дух: призывает облако огня, которое медленно движется в сторону ближайшего противника. Самоуничтожается через m секунд, если не найдёт цель.
  ...
  7. огненная метка: накладывает на цель эффект "огненная метка". Если отмеченная цель получит критический урон, взывает к стихии и наносит урон всем врагам в большом радиусе вокруг вас.
- Холод:
  ...
  5. вытягивание энергии: накладывает выбранную цель эффект "заморозка" и взывает к стихии.
...
- Земля:
  ...
  2. щит земли: защищает от урона (n атак), пока активен. Мгновенное.
  3. чумная зона: обновляет негативные эффекты на противниках в этой зоне.
  4. природная сила: восстанавливает здоровье заклинателя или выбранной цели, если она союзная.
  5. заражение: "заражает" выбранную цель.
...
- Нейтрал:
  ...
  5. сайленс: накладывает на цель "безмолвие".
  6. 
  7.
- Прочее:
...
4. Морозная стихия: вы можете применять заклинания стихии "мороз", находясь под эффектом "заморозка".
