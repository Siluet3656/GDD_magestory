...
0. Основные положения:
    ...
    - Карта выглядит как тюрьма с центральным круглым помещением и 4мя ответвленями
1. Обучение
    - представляет собой 1е крыло, которое специально выделено под главного героя
    - Поэтапное введения игрока во все механики
3. Стартовая локация/лобби (тюрьма):
    - Противники:
    - заключенный
    - охотник
    - паладин
    - Окружение:
      - Тюремные вещи, каменные стены, клетки
    - Цель и проходы:
      - начало игры, состоит из нескольких крыльев (4)
      - проход к боссу
      - проходы во все побочные (3, стихийные залы)
      - торговец
      - Безэлементальый бонус появляется здесь шансово: 0% старт и +33% за каждыйый зачищенный элементальный. Минибосс для получения
...
3. Огненные залы:
    ...
    - Цель и проходы:
      ...
      - Минбосс в конце (не обязательно босс, мб какой челлендж)
4. Морозные залы:
    - Противники:
      - снеговики
      - йети
