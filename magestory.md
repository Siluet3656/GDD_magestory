...
- корни: делает невозможным передвижение, но цель продолжает получать урон. Эффект пропадает при получении урона.
### Система заклинаний
...
- Холод:
  ...
  5. вытягивание энергии: накладывает выбранную цель эффект "заморозка" и взывает к стихии дважды.
...
- Земля:
  ...
  7. гнев природы: накладывает "корни" на цель и всех врагов в огромном радиусе вокруг цели. Враги в корнях (кроме цели заклинания) получают урон раз в секунду. Цель получает исцеление равно 1/10 сумме всего нанесенного урона.
- Нейтрал:
